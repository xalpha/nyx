...
public:
	...
	void attachColorTexture( unsigned int colorTex, unsigned int width, unsigned int height, bool keepDepthBuffer=false );
	void attachDepthTexture( unsigned int depthTex, unsigned int width, unsigned int height, bool keepColorBuffer=false );
	void attachTextures( unsigned int colorTex, unsigned int depthTex );

	void attachColorTexture( const nyx::Texture<T> &colorTex );
	void attachDepthTexture( const nyx::Texture<T> &depthTex );
	void attachTextures( const nyx::Texture<T> &colorTex, const nyx::Texture<T> &depthTex );
...
protected:
	void check();
	void cleanUp( bool keepColorBuffer=false, bool keepDepthBuffer=false );
...
template<typename T>
inline void frame_buffer_objects<T>::attachColorTexture( unsigned int colorTex, unsigned int width, unsigned int height, bool keepDepthBuffer )
{
	if( colorTex != 0 )
	{
		// init stuff
...
template<typename T>
inline void frame_buffer_objects<T>::attachDepthTexture( unsigned int depthTex, unsigned int width, unsigned int height, bool keepColorBuffer )
{
	if( depthTex != 0 )
	{
		// init stuff
...
template<typename T>
inline void frame_buffer_objects<T>::attachTextures( unsigned int colorTex, unsigned int depthTex )
{
...
template<typename T>
inline void frame_buffer_objects<T>::attachColorTexture( const nyx::Texture<T> &colorTex )
{
	attachColorTexture( colorTex.getIdentifier(), colorTex.getWidth(), colorTex.getHeight() );
}


template<typename T>
inline void frame_buffer_objects<T>::attachDepthTexture( const nyx::Texture<T> &depthTex )
{
	attachDepthTexture( depthTex.getIdentifier(), depthTex.getWidth(), depthTex.getHeight() );
}


template<typename T>
inline void frame_buffer_objects<T>::attachTextures( const nyx::Texture<T> &colorTex, const nyx::Texture<T> &depthTex )
{
	attachTextures( colorTex.getIdentifier(), depthTex.getIdentifier() );
}
...
template<typename T>
inline void frame_buffer_objects<T>::cleanUp(  bool keepColorBuffer, bool keepDepthBuffer )
{
