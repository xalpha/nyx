...
class test_mesh : public QOpenGLWidget, public nyx::widget<float>
{
    Q_OBJECT

public:
    test_mesh( const std::string& path );
    ~test_mesh();
...
protected:
    nyx::mesh<float,unsigned int,3> m_mesh;
};
